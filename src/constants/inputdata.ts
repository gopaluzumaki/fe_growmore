...
export const Add_TenancyContractProperty = [
  ...
  { label: "Security Deposite Amount", name: "securityDepositeAmt", type: "text" },
  { label: "Brokarage", name: "brokarage", type: "text" },
  { label: "Brokarage Amount", name: "brokarageAmt", type: "text" },
];
